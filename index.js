...
mongoose.connect('mongodb://diego1:DEFTONES1*@cluster0-shard-00-00.vmzh1.mongodb.net:27017,cluster0-shard-00-01.vmzh1.mongodb.net:27017,cluster0-shard-00-02.vmzh1.mongodb.net:27017/Cluster0?ssl=true&replicaSet=atlas-9hikb0-shard-0&authSource=admin&retryWrites=true&w=majority', (err,res) => {
    if(err)
    {        
    throw err;
}
